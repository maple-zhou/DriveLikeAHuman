...
from LLMDriver.agent_propmts import SYSTEM_MESSAGE_PREFIX, SYSTEM_MESSAGE_SUFFIX, FORMAT_INSTRUCTIONS, HUMAN_MESSAGE, TRAFFIC_RULES, DECISION_CAUTIONS, NEW_DECISION_CAUTIONS, NEW_SYSTEM_MESSAGE_SUFFIX, NEW_TRAFFIC_RULES
...
class SimpleDriverAgent:
    ...
    def agentRun(self, last_step_decision: dict):
        ...
        with get_openai_callback() as cb:
            self.agent.run(
                f"""
                You are a driving assistant on car "ego" who help maneuver it. You are located on either lane 0,1,2,3. You can choose to accelerate, decelerate, maintain your current speed, or change lane. Your goal is to maneuver the car safely, smoothly and quickly.
                ...
                Here is the current scenario: \n ```json\n{self.sce.export2json()}\n```\n. 
                Please make decision for the `ego` car. You have to check the safety of your movement before finally outputing your decision. 
                ...
                Let's think step by step. You should give me the explanation why you choose certain movement. You should produce some mathematical derivation to help clean your mind. Once you made a final decision, output it in exact following format. String 'Final Anser' should only appear inside the ``` blob: \n
                ```
                Final Answer: 
                    "decision":{{"ego car's decision, ONE of the available actions"}},
                    "explanations":{{"your explanation about your decision, described your suggestions to the driver"}}
